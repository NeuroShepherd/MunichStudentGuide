...
According to Germany's Federal Foreign Office, student's from non-EU countries must demonstrate that they have "adequate financial resources" to finance their stay in Germany. As of `r params$funding_year`, the minimum required amount of funding that one must demonstrate is `r params$funding_amount`/year. There are two primary options for demonstrating proof that you have these funds:
...
Working part-time during one's studies is exceptionally common, and most students pick up positions as assistants at their university, as a waiter/waitress, or find some other part-time work to supplement their budgets. As of `r params$min_wage_date`, the minimum wage in Germany is €`r params$min_wage_amount`, and students may earn up to `r params$tax_threshold` in mini jobs before being required to pay taxes. See the [DAAD Side Jobs page](https://www.daad.de/en/study-and-research-in-germany/first-steps-germany/side-jobs/) for additional details and links to source information. 

The rules for international students hoping to work can be somewhat complex and confusing in some situations, but, generally speaking, working less than 20 hours/week is acceptable so one can potentially earn ~€`r params$min_wage_amount*4*20`/month without any legal concerns. The [Work Regulations chapter](#chapter-work-regulations) covers these details in more detail.
